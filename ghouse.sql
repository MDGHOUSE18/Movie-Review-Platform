...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 12, 2022 at 07:38 AM
...
('Avengers', '2001-06-06', 0, 'Adventure', 3, 'https://m.media-amazon.com/images/M/MV5BMjMxNjY2MDU1OV5BMl5BanBnXkFtZTgwNzY1MTUwNTM@._V1_FMjpg_UX1000_.jpg', 'English'),
('RRR', '2022-06-06', 0, 'Drama', 4, 'https://stat2.bollywoodhungama.in/wp-content/uploads/2019/03/RRR-2022-306x393.jpeg', 'Telugu'),
('Conjuring', '2006-11-14', 0, 'Horror', 5, 'https://images.squarespace-cdn.com/content/v1/511eea22e4b06642027a9a99/1473717135106-6WRDQJ3A6DBGMP2O938T/The+Conjuring+2.jpg', 'English'),
('God Father ', '2022-10-02', 0, 'Action', 6, 'https://images.news18.com/ibnlive/uploads/2022/07/god-father.jpg', 'Telugu'),
('Joker', '2019-10-02', 0, 'Horror', 35, 'https://upload.wikimedia.org/wikipedia/en/thumb/e/e1/Joker_%282019_film%29_poster.jpg/220px-Joker_%282019_film%29_poster.jpg', 'English, Telugu, Hindi, Tamil');
...
(10, 'Abid', 'abid@gmail.com', 'abid', 0);

-- --------------------------------------------------------

--
-- Table structure for table `usersmovie`
--

CREATE TABLE `usersmovie` (
  `name` varchar(100) DEFAULT NULL,
  `year` varchar(100) DEFAULT NULL,
  `rating` int(10) DEFAULT NULL,
  `genre` varchar(100) DEFAULT NULL,
